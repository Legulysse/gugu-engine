...
int main(int argc, char* argv[])
{
    ...
    // Path
    {
        std::string pathA, pathB, pathC, pathD, pathE, pathF, pathG, pathH, pathI, pathJ, pathK, pathL, pathM, pathN, pathO, pathP, pathQ;
        NormalizePath("", false, pathA);                            // ""
        NormalizePath("/", false, pathB);                           // ""
        NormalizePath("./hello/my/../world", false, pathC);         // "hello/world"
        NormalizePath("../hello/world", false, pathD);              // "../hello/world"
        NormalizePath("hello/world/../..", false, pathE);           // ""
        NormalizePath("hello/world/../../../..", false, pathF);     // "../.."
        NormalizePath("../../hello/my/../world/../", false, pathG); // "../../hello"
        NormalizePath("./", false, pathH);                          // ""
        NormalizePath("../", false, pathI);                         // ".."
        NormalizePath("/..", false, pathJ);                         // ".."
        NormalizePath("/../", false, pathK);                        // ".."
        NormalizePath("/../", false, pathL);                        // ".."
        NormalizePath("../hello/world/..", false, pathM);           // "../hello"
        NormalizePath("///////", false, pathN);                     // ""
        NormalizePath(".///////", false, pathO);                    // ""
        NormalizePath(".//.///.//", false, pathP);                  // ""
        NormalizePath(".folder/hello../..../..world/....", false, pathQ);   // ".folder/hello../..../..world/...."
    }

    {
        std::string pathA, pathB, pathC, pathD, pathE, pathF, pathG, pathH, pathI, pathJ, pathK, pathL, pathM;
        NormalizePath("", true, pathA);                             // ""
        NormalizePath("/", true, pathB);                            // ""
        NormalizePath("./hello/my/../world", true, pathC);          // "hello/world/"
        NormalizePath("../hello/world", true, pathD);               // "../hello/world/"
        NormalizePath("hello/world/../..", true, pathE);            // ""
        NormalizePath("hello/world/../../../..", true, pathF);      // "../../"
        NormalizePath("../../hello/my/../world/../", true, pathG);  // "../../hello/"
        NormalizePath("./", true, pathH);                           // ""
        NormalizePath("../", true, pathI);                          // "../"
        NormalizePath("/..", true, pathJ);                          // "../"
        NormalizePath("/../", true, pathK);                         // "../"
        NormalizePath("/../", true, pathL);                         // "../"
        NormalizePath("../hello/world/..", true, pathM);            // "../hello/"
    }

    {
        std::string pathA, pathB, pathC, pathD, pathE, pathF, pathG;
        PathFromPathFile("", false, pathA);                                 // ""
        PathFromPathFile("./hello/my/../world/", false, pathB);             // "hello/world"
        PathFromPathFile("./hello/my/../world.xml", false, pathC);          // "hello"
        PathFromPathFile("./hello/my/../world", false, pathD);              // "hello/world"
        PathFromPathFile("./hello/my/../my.world/", false, pathE);          // "hello/my.world"
        PathFromPathFile("./hello/my/../my.world/file.xml", false, pathF);  // "hello/my.world"
        PathFromPathFile("file.xml", false, pathG);                         // ""
    }

    {
        std::string pathA, pathB, pathC, pathD, pathE, pathF, pathG;
        PathFromPathFile("", true, pathA);                                  // ""
        PathFromPathFile("./hello/my/../world/", true, pathB);              // "hello/world/"
        PathFromPathFile("./hello/my/../world.xml", true, pathC);           // "hello/"
        PathFromPathFile("./hello/my/../world", true, pathD);               // "hello/world/"
        PathFromPathFile("./hello/my/../my.world/", true, pathE);           // "hello/my.world/"
        PathFromPathFile("./hello/my/../my.world/file.xml", true, pathF);   // "hello/my.world/"
        PathFromPathFile("file.xml", true, pathG);                         // ""
    }

    {
        std::string pathA, pathB, pathC, pathD, pathE, pathF, pathG, pathH, pathI, pathJ;
        CombinePaths("", "", false, pathA);                 // ""
        CombinePaths("/hello/", "/world/", false, pathB);   // "hello/world"
        CombinePaths("/", "/", false, pathC);               // ""
        CombinePaths("../hello", "../world", false, pathD); // "../world"
        CombinePaths("../hello/..", "world", false, pathE); // "../world"
        CombinePaths("hello/my", "./world", false, pathF);  // "hello/my/world"
        CombinePaths("/hello/", "", false, pathG);          // "hello"
        CombinePaths("", "/world/", false, pathH);          // "world"
        CombinePaths("/../", "/../", false, pathI);         // "../.."
        CombinePaths("..", "..", false, pathJ);             // "../.."
    }

    {
        std::string pathA, pathB, pathC, pathD, pathE, pathF, pathG, pathH, pathI, pathJ;
        CombinePaths("", "", true, pathA);                  // ""
        CombinePaths("/hello/", "/world/", true, pathB);    // "hello/world/"
        CombinePaths("/", "/", true, pathC);                // ""
        CombinePaths("../hello", "../world", true, pathD);  // "../world/"
        CombinePaths("../hello/..", "world", true, pathE);  // "../world/"
        CombinePaths("hello/my", "./world", true, pathF);   // "hello/my/world/"
        CombinePaths("/hello/", "", true, pathG);           // "hello/"
        CombinePaths("", "/world/", true, pathH);           // "world/"
        CombinePaths("/../", "/../", true, pathI);          // "../../"
        CombinePaths("..", "..", true, pathJ);              // "../../"
    }
