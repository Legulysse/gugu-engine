...
void RunUnitTests_Math(UnitTestResults* results)
{
    ...
    GUGU_UTEST_SECTION("Common");
    {
        ...
        {
            GUGU_UTEST_CHECK_EQUAL(RoundNearestInt(10.5f), 11);
            GUGU_UTEST_CHECK_EQUAL(RoundNearestInt(-10.5f), -11);
            GUGU_UTEST_CHECK_EQUAL(RoundNearestInt(10.2f), 10);
            GUGU_UTEST_CHECK_EQUAL(RoundNearestInt(-10.2f), -10);
            GUGU_UTEST_CHECK_EQUAL(RoundNearestInt(10.8f), 11);
            GUGU_UTEST_CHECK_EQUAL(RoundNearestInt(-10.8f), -11);
        ...
        GUGU_UTEST_SUBSECTION("Modulo");
        {
            ...
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(0, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(1, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(-1, 10), -1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(9, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(-9, 10), -9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(-10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(19, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(-19, 10), -9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(20, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(std::fmodf(-20, 10), 0.f, math::Epsilon6);
            ...
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(0, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(1, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(-1, 10), -1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(9, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(-9, 10), -9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(-10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(19, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(-19, 10), -9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(20, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(TruncatedModulof(-20, 10), 0.f, math::Epsilon6);
            ...
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(0, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(1, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(-1, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(9, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(-9, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(-10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(19, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(-19, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(20, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(FlooredModulof(-20, 10), 0.f, math::Epsilon6);
            ...
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(0, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(1, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(-1, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(9, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(-9, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(-10, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(19, 10), 9.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(-19, 10), 1.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(20, 10), 0.f, math::Epsilon6);
            GUGU_UTEST_CHECK_APPROX_EQUAL(EuclideanModulof(-20, 10), 0.f, math::Epsilon6);
    ...
    GUGU_UTEST_SECTION("Random");
    {
        ...
        {
            {
                const float sampleCount = 100000;
                ...
                for (int i = 0; i < sampleCount; ++i)
                {
                    resultsR.insert(GetRandf());
                }

                GUGU_UTEST_CHECK_EQUAL(resultsA.size(), 10);
                GUGU_UTEST_CHECK_EQUAL(resultsA.begin()->first, 0);
                GUGU_UTEST_CHECK_EQUAL(resultsA.rbegin()->first, 9);
                ...
                GUGU_UTEST_CHECK(ApproxSuperiorOrEqual(*resultsC.begin(), 0.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxInferiorOrEqual(*resultsC.rbegin(), 10.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxSuperiorOrEqual(*resultsD.begin(), 0.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxInferiorOrEqual(*resultsD.rbegin(), 5.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxSuperiorOrEqual(*resultsDD.begin(), -5.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxInferiorOrEqual(*resultsDD.rbegin(), 0.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxSuperiorOrEqual(*resultsDDD.begin(), -5.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxInferiorOrEqual(*resultsDDD.rbegin(), 5.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxSuperiorOrEqual(*resultsR.begin(), 0.f, math::Epsilonf));
                GUGU_UTEST_CHECK(ApproxInferiorOrEqual(*resultsR.rbegin(), 1.f, math::Epsilonf));
            }
        }
